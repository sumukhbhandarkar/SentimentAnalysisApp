...
Happy = ("glad, happy, accidental, advantageous, appropriate, apt, auspicious, befitting, casual, convenient, correct, effective, efficacious, enviable, favorable, felicitous, fitting, fortunate, incidental, just, meet, nice, opportune, promising, proper, propitious, providential, right, satisfactory, seasonable, successful, suitable, timely, well-timed").split(", ")
